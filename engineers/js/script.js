// ================= CONFIGURATION =================
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwVug8xgOBwxK3C2U39z5iHAgXsm0N9AfrBfEOmbneRPtGMmX-__yPk5TnHODEdQ4s7iQ/exec";
...
function initPdfGeneratorEngine() {
  ...
  // =========================================================================
  // STRICTLY UNTOUCHED PDF EXPORT ENGINE - PRESERVED EXACTLY AS DEVELOPED
  // =========================================================================
